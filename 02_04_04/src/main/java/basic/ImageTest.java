...
public class ImageTest {
    public static void main(String[] args) throws Exception {
        readAndWrite();
        readComparison();
        cropImage("02_04_04/test1.jpg", "02_04_04/test2.jpg", 750, 250, 700, 300, "jpg", "jpg");
        combineImagesHorizontally("02_04_04/test1.jpg", "02_04_04/test1.jpg", "jpg", "02_04_04/test3.jpg");
        combineImagesVertically("02_04_04/test1.jpg", "02_04_04/test1.jpg", "jpg", "02_04_04/test4.jpg");
    }

    public static void readAndWrite() throws Exception {
        BufferedImage image = ImageIO.read(new File("02_04_04/test1.jpg"));
        System.out.println("Height: " + image.getHeight()); // 高度像素
        System.out.println("Width: " + image.getWidth()); // 宽度像素
        ImageIO.write(image, "png", new File("02_04_04/test1.png"));
    }
    ...
    public static void readComparison() throws Exception {
        ...
        ImageInputStream iis = ImageIO.createImageInputStream(new File("02_04_04/test1.jpg"));
