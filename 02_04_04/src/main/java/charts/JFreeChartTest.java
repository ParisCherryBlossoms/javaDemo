...
public class JFreeChartTest {
    public static void main(String[] args) {
        writeBar("02_04_04/bar.jpg"); // 柱状图
        writePie("02_04_04/pie.jpg"); // 饼图
        writeLine("02_04_04/line.jpg");// 折线图
    }
    ...
    public static void writeBar(String fileName) {
        ...
        JFreeChart chart = ChartFactory.createBarChart("柱状图", "2018年", "产品总量", dataset, PlotOrientation.VERTICAL, false, false, false);
        try {
            saveChartAsJPEG(new File(fileName), chart, 600, 300);
        } catch (IOException e) {
            e.printStackTrace();
        }
