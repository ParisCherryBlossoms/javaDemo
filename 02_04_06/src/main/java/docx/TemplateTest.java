...
public class TemplateTest {
    public static void main(String[] args) throws Exception {
        ...
        writeDocx(doc, new FileOutputStream("02_04_06/template2.docx"));//输出
    }
     ...
     * @throws Exception
     */
    public static void replaceTable(IBodyElement para ,Map<String, Object> params, Map<String, String> picParams, XWPFDocument indoc) throws Exception {
        Matcher matcher;
        XWPFTable table;
